...
|  평가자  | 회고 내용 |
|----------|-----------|
|  윤찬호  | EDA와 변수 분포 분석을 통해 데이터의 전체 흐름을 이해하는 데 큰 도움을 주셨습니다.
...
|----------|-----------|
|  김용욱  |  |
|  윤찬호  | churn_any 분석과 교차검증, 튜닝을 맡아 프로젝트의 핵심 모델 기준을 정리해주셨습니다.
...
|----------|-----------|
|  김용욱  |  |
|  윤찬호  | 희소 라벨인 churn_to_mvno 문제를 맡아 threshold 비교와 한계 해석까지 꼼꼼하게 정리해주셨습니다.
단순 성능 비교를 넘어서 왜 예측이 어려운지도 함께 설명해주셔서 해석의 신뢰도를 높여주셨습니다. |
...
|----------|-----------|
|  김용욱  |  |
|  윤찬호  | 최종 요약과 PPT 정리를 맡아 각자 진행한 분석 결과를 하나의 흐름으로 잘 연결해주셨습니다.
