...
<table>
  ...
  <tr>
    ...
    <td>프로젝트 간의 기본 틀을 잡아주면서 노션, 깃허브 등 기반 정리를 해주면서 팀원들이 무엇을 해나갸야하는지 잘 이끌어주셨습니다.</td>
  </tr>
  <tr>
    <td align="center"><nobr>전승권</nobr></td>
...
<table>
  ...
  <tr>
    <td align="center"><nobr>윤찬호</nobr></td>
    <td>
      churn_any 분석과 교차검증, 튜닝을 맡아 프로젝트의 핵심 모델 기준을 정리해주셨습니다.<br>
...
<table>
  ...
  <tr>
    <td align="center"><nobr>윤찬호</nobr></td>
    <td>
      희소 라벨인 churn_to_mvno 문제를 맡아 threshold 비교와 한계 해석까지 꼼꼼하게 정리해주셨습니다.<br>
